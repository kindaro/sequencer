...
newtype CClockHack     = CClockHack     CClock
newtype CTimeHack      = CTimeHack      CTime
newtype CUSecondsHack  = CUSecondsHack  CUSeconds
newtype CSUSecondsHack = CSUSecondsHack CSUSeconds
